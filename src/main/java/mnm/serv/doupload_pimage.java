 ...
 */
public class doupload_pimage extends HttpServlet {
    private static final long serialVersionUID = 1L;

    private static final String DATA_DIRECTORY = "/website/jbpms/res/img/product";
...
//                    String filename=DATA_DIRECTORY+"/links"+UUID.randomUUID().getLeastSignificantBits()+"";
                    ...
                    if(fieldname.startsWith("title")){
                        ...
                        title  =new String(fieldvalue.getBytes("ISO8859_1"), "UTF-8");;
                    }
        ...
        d.insert_pimage(id2, filename2);
            request.setAttribute("message", " تکمییل شد!!");
            request.setAttribute("status", true);
//            save(reads, seo);
            // displays done.jsp page after upload finished
            getServletContext().getRequestDispatcher("/panel/image.jsp?id="+id2+"&title="+title).forward(
                    request, response);
