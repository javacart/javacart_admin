 ...
 */
public class productidel extends HttpServlet{
    public void doGet(HttpServletRequest request,
        ...
        getServletContext().getRequestDispatcher("/panel/image.jsp?id="+request.getParameter("id2")+"&title="+request.getParameter("title")).forward(
                    request, response); 
